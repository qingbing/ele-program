  ...
  methods: {
    ...
    getHeaders(cb) {
      ...
      const promise = {
        ...
        options: getFormOptions("program-logs-interface-access"),
        headers: getHeaderOptions("program-logs-interface-access"),
      };
    ...
    getData(cb) {
      ReqLogs.interfaceAccessList(merge(this.query.search, this.pagination))
